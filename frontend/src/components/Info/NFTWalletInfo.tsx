        ...
        <div className="space-y-6 overflow-y-auto flex-1 pr-2">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-blue-800 text-sm">
                  Your NFTs are safely stored on the Base blockchain, but they may not automatically 
              ...
              <div className="flex items-start gap-3 p-3 bg-green-50 rounded-lg border border-green-200">
                ...
                <div>
                  ...
                  <p className="text-sm text-green-800">
                    Your NFTs are properly minted and owned by your wallet address on Base
                  </p>
                </div>
              </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="p-3 bg-orange-50 rounded-lg border border-orange-200">
                ...
                <p className="text-sm text-orange-800">
                  Base is a newer network, and wallet support for NFTs may be limited compared 
                  to Ethereum mainnet.
                </p>
              </div>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <Badge variant="secondary" className="w-full justify-start p-3">
                <span className="font-medium">2. Check Base Explorers</span>
                <span className="ml-2 text-sm">View your NFTs on Basescan </span>
              </Badge>
