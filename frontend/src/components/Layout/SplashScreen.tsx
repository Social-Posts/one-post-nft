      ...
      <div className="relative z-10 flex flex-col items-center gap-6 animate-fade-in">
        ...
        <div className="relative animate-scale-in">
          ...
          <img
            src={onePostNftLogo}
            alt="OnePostNft Logo"
            className="relative w-32 h-32 md:w-40 md:h-40 object-contain rounded-full shadow-2xl animate-bounce-slow"
          />
        </div>
        ...
        {showText && (
          <div className="flex flex-col items-center gap-2">
            <h1 className="text-xl md:text-5xl font-bold text-[#00BFFF] animate-typewriter overflow-hidden whitespace-nowrap border-r-4 border-primary pr-2">
              OnePostNft
            </h1>
        ...
        <div className="mt-8 flex gap-2">
          <div className="w-2 h-2 bg-[#00BFFF] rounded-full animate-bounce" style={{ animationDelay: '0ms' }} />
          <div className="w-2 h-2 bg-[#00BFFF] rounded-full animate-bounce" style={{ animationDelay: '150ms' }} />
          <div className="w-2 h-2 bg-[#00BFFF] rounded-full animate-bounce" style={{ animationDelay: '300ms' }} />
        </div>
      </div>
