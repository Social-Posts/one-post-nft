...
const WalletPage: React.FC = () => {
  ...
  const anyWalletConnected = isConnected;
        ...
        {isConnected && address && (
          <Card className="p-6 bg-card border-border">
            <div className="text-center space-y-4">
              ...
              <div>
                <h2 className="text-xl font-bold text-foreground mb-2">Base Wallet Connected</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-6">
              <div className="text-center p-4 bg-muted/50 rounded-lg">
                ...
                <div className="text-xs text-muted-foreground">Base Protected</div>
              </div>
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-3 p-3 bg-muted/30 rounded-lg">
              ...
              <div>
                ...
                <div className="text-sm text-muted-foreground">Your NFTs are secured on Base</div>
              </div>
            </div>
          </div>
        </Card>
    ...
    <div className="space-y-6 animate-fade-in">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Connect your Base wallet to start creating and trading NFTs
            </p>
          </div>
        ...
        <div className="space-y-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <div className="text-sm text-muted-foreground">
                Transform your daily posts into unique, tradeable NFTs on Base
              </div>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <div className="text-sm text-muted-foreground">
                Powered by Base's secure and scalable Layer 2 technology
              </div>
            </div>
          </div>
        </div>
      ...
      <Card className="p-4 bg-muted/50 border-border">
        <div className="text-center text-sm text-muted-foreground">
          <p>Supported wallets: MetaMask, Coinbase Wallet, WalletConnect (Base)</p>
