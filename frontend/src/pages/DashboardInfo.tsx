          ...
          <div className="text-center space-y-6">
            ...
            <div className="space-y-4 text-muted-foreground leading-relaxed">
              <p className="text-lg">
                ...
                Base where every post becomes a valuable NFT. We're
              ...
              <p>
                ...
                Every post is automatically minted as an NFT on Base, giving
              ...
              <p>
                ...
                Your content is stored on IPFS and secured by Base's
